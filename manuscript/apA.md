...
[In Chapter 3](ch3.md/#user-content-shortlongenough), we used these predicate functions to test a single word. Then [in Chapter 9](ch9.md/#filter), we learned how to repeat such tests using list operations like `filter(..)`. For example:
